!function (e) {
    ...
    t.prototype = {
        constructor: t, setColor: function (t) {
            t = t.toLowerCase();
            var n = this;
    ...
    e.fn.colorpicker = function (t, r) {
        return this.each(function () {
            ...
            if (!s) {
                i.data("colorpicker", s = new n(this, e.extend({}, e.fn.colorpicker.defaults, o)))
            }
    ...
    var r = {
        ...
        HueToRGB: function (e, t, n) {
            if (n < 0)n += 1; else if (n > 1)n -= 1;
            if (n * 6 < 1)return e + (t - e) * n * 6; else if (n * 2 < 1)return t; else if (n * 3 < 2)return e + (t - e) * (2 / 3 - n) * 6; else return e
        },
