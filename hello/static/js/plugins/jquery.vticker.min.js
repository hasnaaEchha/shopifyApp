...
(function (d) {
    var m = {
        ...
        moveUp: function (a, b) {
            ...
            var c = a.itemHeight, f = a.options, g = a.element.children("ul"), k = "up" === e ? "li:first" : "li:last", l = g.children(k).clone(!0);
            ...
            var a = d(this).data("state"), b = this;
        ...
        init: function (a) {
            ...
            d(this).data("state", e);
            b.css({overflow: "hidden", position: "relative"}).children("ul").css({
                position: "absolute",
                margin: 0, padding: 0
            }).children("li").css({margin: a.margin, padding: a.padding});
    ...
    d.fn.vTicker = function (a) {
        ...
        if ("object" !== typeof a && a)d.error("Method " + a + " does not exist on jQuery.vTicker"); else return f.init.apply(this, arguments)
    }
})(jQuery);
