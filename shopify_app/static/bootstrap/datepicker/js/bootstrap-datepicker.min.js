(function (e) {
    ...
    var i = function (t, n) {
        ...
        if (this.o.rtl) {
            ...
            this.picker.find(".prev i, .next i").toggleClass("fa fa-arrow-left icon-arrow-right")
        }
    ...
    i.prototype = {
        constructor: i, _process_options: function (t) {
    ...
    var h = {
        ...
        parseDate: function (t, r, s) {
            ...
            var u = t && t.match(this.nonpunctuation) || [], t = new Date, p = {}, d = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], v = {
                yyyy: function (e, t) {
